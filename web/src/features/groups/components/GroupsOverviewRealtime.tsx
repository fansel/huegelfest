...
export function GroupsOverviewRealtime() {
  const { data, loading, connected, refreshData } = useGroupsRealtime();
  ...
  const handleRegistrationStatusChange = async (field: 'paid' | 'checkedIn', value: boolean) => {
    ...
    if (res.success && res.updated) {
      ...
      // Kein manuelles State-Update nötig - WebSocket wird automatisch synchronisieren
    }
  };
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* Dialogs - Kein manuelles State-Update nötig, WebSocket synchronisiert automatisch */}
      <CreateGroupDialog
