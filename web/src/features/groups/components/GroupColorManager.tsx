...
import { getGroupColorsAction } from '../actions/getGroupColors';
...
export default function GroupColorManager({ onSaveGroupColors }: GroupColorManagerProps) {
  ...
  useEffect(() => {
    const loadGroups = async () => {
      const loadedGroups = await getGroupColorsAction();
      // Default-Gruppe ausblenden
      const { default: _default, ...groupsWithoutDefault } = loadedGroups;
      setGroups(groupsWithoutDefault);
    };
