...
import type { User } from '@/features/groups/components/types';
import type { RegistrationWithId } from '@/features/groups/components/types';
 ...
 */
export async function fetchGroupsData(): Promise<GroupsData> {
  try {
