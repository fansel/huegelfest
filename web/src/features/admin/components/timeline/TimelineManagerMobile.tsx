...
const TimelineManagerMobile: React.FC = () => {
  ...
  return (
    <div className="bg-white/90 p-2 rounded-2xl shadow max-w-lg mx-auto mt-4">
      <h2 className="text-lg font-bold mb-4 text-[#460b6c] text-center">Timeline</h2>
        ...
        {timeline?.days.map((day, dayIdx) => (
          <div key={dayIdx} className="bg-gray-50 rounded-xl shadow p-4">
            <div className="flex justify-between items-center mb-2">
              <div>
                <div className="font-bold text-base text-[#460b6c]">{day.title}</div>
...
export default TimelineManagerMobile; 