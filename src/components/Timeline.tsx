...
import { FaMusic, FaUsers, FaUtensils, FaCampground, FaGamepad, FaQuestion, FaFilter, FaHeart, FaRegHeart, FaList } from 'react-icons/fa';
          ...
          <div className="flex justify-center">
            <div className="flex space-x-2 overflow-x-auto pb-2 px-4">
              ...
              {categories.map((category) => (
                ...
                >
                  {React.createElement(Icons[category.icon as keyof typeof Icons], { className: "text-lg" })}
                </button>
              ))}
            </div>
          </div>
